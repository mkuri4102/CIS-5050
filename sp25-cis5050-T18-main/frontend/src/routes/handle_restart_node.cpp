 ...
 * 
 * Provides functionality for the admin dashboard to restart a specific node.
 * Implements:
 * - Node identification by ID
 * - Socket connection to the target node
 * - Sending RESTART command to gracefully restart the node
...
namespace Routes {
    ...
    void handle_restart_node(int client_fd, const std::string& body, bool keep_alive) {
